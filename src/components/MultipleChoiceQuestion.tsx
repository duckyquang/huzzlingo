...
import type { MultipleChoiceQuestion as MultipleChoiceQuestionType } from '../types/lesson';
      ...
      <div className="grid grid-cols-1 gap-3">
        {question.options.map((option, index) => (
          <motion.button
            ...
            className={`relative p-4 text-left rounded-xl border-2 transition-colors ${
              selectedAnswer
